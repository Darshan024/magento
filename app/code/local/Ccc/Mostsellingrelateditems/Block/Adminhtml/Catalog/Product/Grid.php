<?php
class Ccc_Mostsellingrelateditems_Block_Adminhtml_Catalog_Product_Grid extends Mage_Adminhtml_Block_Widget_Grid
{

    public function __construct()
    {
        parent::__construct();
        $this->setTemplate('mostsellingrelateditems/grid.phtml');
    ...
    protected function _prepareCollection()
    {
        ...
        if($this->getRequest()->getParam('showdetail')=='true'){
            ...
            foreach($productModel as $product){
                $productArr[] = $product['related_product_id'];
            }
            $collection->addFieldToFilter('entity_id', $productArr);
        }
        else{

...
{
    /**
     * Initialize banner page edit block
     *
     * @return void
     */
    ...
    {
        if (Mage::registry('banner_banner')->getId()) {
            return Mage::helper('banner')->__("Edit Banner ", $this->escapeHtml(Mage::registry('banner_banner')->getTitle()));
        } else {
